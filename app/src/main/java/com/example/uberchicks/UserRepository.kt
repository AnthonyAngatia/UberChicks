...
class UserRepository @Inject constructor(private val dataStore: DataStore<Preferences>) {
    ...
    //UserPreference exposed as a flow
    val userPreferenceFlow: Flow<UserPreference> = dataStore.data
        .map { preferences ->
            ...
            val phoneNumber = preferences[UserPreferenceKeys.PHONE_NUMBER] ?: ""
            val token = preferences[UserPreferenceKeys.TOKEN] ?: ""
            val isLoggedIn = preferences[UserPreferenceKeys.IS_LOGGED_IN] ?: false

            UserPreference(userId, firstName, lastName, phoneNumber, userEmail, token, isLoggedIn)
        }
    ...
    suspend fun addUser() {
        dataStore.edit { mutablePreferences ->
            ...
            mutablePreferences[UserPreferenceKeys.PHONE_NUMBER] = "0791278088"
